...
<body>
<form action="/backstage/Discount/add" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="available" value="0" checked/> 禁用
                <input type="radio" name="available" value="1"/> 启用
            </td>
        </tr>
        <tr>
