...
<div id="web">
    ...
    <div class="main">
        ...
        <div class="main-top" >
            <h2>${ticketVO.ticketPO.title}</h2>
            <div id="demo1" class="picBtnTop">
                <div class="hd">
                    <ul>
                        <c:forEach items="${ticketVO.ticketPO.picture}" var="picture" begin="0" end="3">
            ...
            <div class="table-right">
                <c:choose>
                    <c:when test="${not empty ticketVO.discountPO}">
                        <h1 id="nPrice"><fmt:formatNumber value="${ticketVO.detailList[0].price * ticketVO.discountPO.percent}" maxFractionDigits="1"/></h1>
                        <span>原价：<b>￥</b><b style="text-decoration:line-through;" id="oPrice"><fmt:formatNumber value="${ticketVO.detailList[0].price}" maxFractionDigits="1"/></b></span>
                    </c:when>
                    <c:otherwise>
                        <h1 id="nPrice"><fmt:formatNumber value="${ticketVO.detailList[0].price}" maxFractionDigits="1"/></h1>
                        <span>原价：<b>￥</b><b style="text-decoration:line-through;" id="oPrice"><fmt:formatNumber value="${ticketVO.detailList[0].price}" maxFractionDigits="1"/></b></span>
                    </c:otherwise>
                </c:choose>
                <span><img src="/frontend/images/hd-n_06.jpg" />${ticketVO.ticketPO.location},<i style="font-style:normal; padding-left:50px;"><img src="/frontend/images/hd-n_03_03.jpg" style="padding:5px 5px 0px 0px;" />跟团游</i></span>
                <div class="table-right-box">
                    <div class="table-right-b-t1">
                        <p>出行日期：</p>
                        <c:forEach items="${ticketVO.detailList}" var="detail">
                    ...
                    <div style="clear:both;"></div>
                    <span>标签：<b>${ticketVO.ticketPO.label}</b></span>
                    <c:if test="${not empty ticketVO.discountPO}">
                        <span>优惠：<b>${ticketVO.discountPO.title} </b>&nbsp;&nbsp;折扣：<b>${ticketVO.discountPO.percent  * 10}折</b></span>
                    </c:if>
                </div>
        ...
        <div class="qzly">
            ...
            <div class="qzly-main">
                <div class="content2-main">
                    ...
                    <div class="bd">
                        <ul>
                            <p style="height: 300px;">${ticketVO.ticketPO.introduce}</p>
                        </ul>
                        <ul>
                            <p style="height: 450px;">${ticketVO.ticketPO.travel}</p>
                        </ul>
                    </div>
                </div>
                <div style="clear:both;"></div>
...
<div class="xd-blk" id="blk7" style="display:none;">
    ...
    <div class="content-line xd-blk1" >
        <p>商品信息：${ticketVO.ticketPO.title}</p>
