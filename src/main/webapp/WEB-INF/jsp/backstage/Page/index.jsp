        ...
        <c:forEach var="picture" items="${pictures}">
            <div class="file-preview-frame file-preview-success" id="${picture}" data-fileindex="0" data-template="image">
                <div class="kv-file-content">
                    <img src="/backstage/Page/image/cut_image/${picture}" class="kv-preview-data file-preview-image" title="${picture}" alt="${picture}" style="width: 291px;height:160px;">
                </div>
...
<script>
    ...
    $(function () {
        ...
        $('#addnew').click(function(){
            ...
            window.location.href="/backstage/Page/upload";
        });
    ...
    $(".kv-file-remove").click(function() {
        ...
        if(confirm("确定要删除吗？"))
        {
            var url = "/backstage/Page/delete?picture=" + $(this).data("id");
