...
<body>
<form action="/backstage/Product/groupTour/add" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="label" name="label"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><textarea type="text" name="introduce"></textarea></td>
        </tr>
        <tr>
            <td class="tableleft">行程</td>
            <td><textarea type="text" name="travel"></textarea></td>
        </tr>
        <tr>
                        ...
                        <div class="file-thumbnail-footer">
                            <div class="file-actions">
                                <div class="file-footer-buttons">
                                    <label class="checkbox inline"> <input type="checkbox" name="picture" value="${picture}" /></label>
                                </div>
                            </div>
                        </div>
                    </div>
