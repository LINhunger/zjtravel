...
<body>
<form action="/backstage/Discount/${discount.id}/update" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            <td width="10%" class="tableleft">标题</td>
            <td><input type="text" name="title" value="${discount.title}"/></td>
        </tr>
        <tr>
            <td class="tableleft">百分比</td>
            <td><input type="text" name="percent" value="${discount.percent}"/></td>
        </tr>
        <tr>
            <td class="tableleft">状态</td>
            <td>
                <input type="radio" name="available" value="0" /> 禁用
                <input type="radio" name="available" value="1" checked/> 启用
            </td>
        </tr>
        <tr>
...
<script>
    $(function () {
        $('#backid').click(function(){
            window.location.href="/backstage/Discount/index";
        });
