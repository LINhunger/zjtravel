...
<body>
<form action="/backstage/Product/ticket/${ticketId}/detail/add" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>

            <td width="10%" class="tableleft">旅游时间</td>
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-success" name="backid" id="backid" data-ticketId="${ticketId}">返回列表</button>
            </td>
        </tr>
...
<script>
    $(function () {
        $('#backid').click(function(){
            ...
            window.location.href="/backstage/Product/ticket/"+ticketId+"/detail";
        });
    });
</script>
